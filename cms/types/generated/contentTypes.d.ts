...
export interface ApiBookAppointmentFormBookAppointmentForm
  extends Struct.CollectionTypeSchema {
  collectionName: 'book_appointment_forms';
  info: {
    displayName: 'Book Appointment Form';
    pluralName: 'book-appointment-forms';
    singularName: 'book-appointment-form';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::book-appointment-form.book-appointment-form'
    > &
      Schema.Attribute.Private;
    Message: Schema.Attribute.Blocks & Schema.Attribute.Required;
    Name: Schema.Attribute.String & Schema.Attribute.Required;
    our_service: Schema.Attribute.Relation<
      'oneToOne',
      'api::our-service.our-service'
    >;
    Phone: Schema.Attribute.String & Schema.Attribute.Required;
    PreferedDate: Schema.Attribute.Date & Schema.Attribute.Required;
    preferredTime: Schema.Attribute.Time & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiGetInTouchMessageGetInTouchMessage
  extends Struct.CollectionTypeSchema {
  collectionName: 'get_in_touch_messages';
  info: {
    displayName: 'Get In Touch Message';
    pluralName: 'get-in-touch-messages';
    singularName: 'get-in-touch-message';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::get-in-touch-message.get-in-touch-message'
    > &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::book-appointment-form.book-appointment-form': ApiBookAppointmentFormBookAppointmentForm;
      ...
      'api::get-in-touch-message.get-in-touch-message': ApiGetInTouchMessageGetInTouchMessage;
