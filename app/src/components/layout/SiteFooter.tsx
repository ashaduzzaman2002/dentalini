        ...
        <div className="container mx-auto grid grid-cols-1 gap-10 py-12 md:grid-cols-2 lg:grid-cols-4 border-t-white/10 border-t text-white">
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link className="story-link" href="/services">
                  Our Services
                </Link>
              </li>
              <li>
                <Link className="story-link" href="/team">
                  Meet the Team
                </Link>
              </li>
              <li>
                <Link className="story-link" href="/faqs">
                  FAQ's
                </Link>
              </li>
              <li>
                <Link className="story-link" href="/reviews">
                  Reviews
                </Link>
              </li>
              <li>
                <Link className="story-link" href="/gallery">
                  Gallery
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white">
              <li>8am - 6pm : Monday - Wednesday, Friday</li>
              <li>8.30am -2pm : Saturday</li>
              <li>Closed : Thursday, Sunday, Public holiday</li>
            </ul>
          </div>
